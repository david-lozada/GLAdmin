  ...
  observer(({ globalStore, purchaseOrderStore }) => {
    ...
    return (
        <MaterialTable
            ...
            columns={purchaseOrderStore.columnsDetails}
            data={purchaseOrderStore.recordDetails}
            ...
            editable={{
              onRowUpdate: (newData, oldData) =>
                new Promise((resolve, reject) => {
                  setTimeout(() => {
                    purchaseOrderStore.updateRecordDetail(newData)
                    resolve()
                  }, 1000)
                }),
              onRowDelete: oldData =>
                new Promise((resolve, reject) => {
                  setTimeout(() => {
                    purchaseOrderStore.deleteRecordDetail(oldData)
                    resolve()
                  }, 1000)
                }),
            }}
